...
const PAGES = [
  ...
  { name: 'product', path: '/laveuses/laveuse-samsung-a-chargement-par-le-haut-blanc' },
  { name: 'product-set', path: '/ensembles-laveuse-secheuse/ensemble-laveuse-addwash-secheuse-multisteam-samsung-noir-sur-piedestaux' },
  { name: 'product-en', path: '/en/dishwashers/lave-vaisselle-frigidaire-gallery-acier-inoxydable' },
